...
async function getMarketPriceHistory() {
    try {
        // const price = await axios.get('https://api.blockchain.info/charts/market-price?timespan=5months&format=json&cors=true')
...
async function getAvgBlockSize() {
    try {
        // const size = await axios.get('https://api.blockchain.info/charts/avg-block-size?timespan=5months&format=json&cors=true')
